...
#ifndef COMMON_BASE_STDEXT_INTRUSIVE_LIST_H_
#define COMMON_BASE_STDEXT_INTRUSIVE_LIST_H_
...
template <typename T, typename MemberType>
const T* member_to_container(const MemberType* member,
...
#endif  // COMMON_BASE_STDEXT_INTRUSIVE_LIST_H_
